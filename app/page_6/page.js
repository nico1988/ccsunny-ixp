...
export default function Page6() {
  ...
  <div class="flex items-center justify-center h-[calc(100vh-130px)] w-[calc(100vw-530px)] ml-[265px]">
    <div class="absolute top-[362px] left-[-35px] w-[272px] h-[228px] rounded-[20px] bg-[rgba(0,255,224,0.3)] flex items-center justify-center cursor-pointer">
    DESINGER
    </div>
    <div class="absolute top-[362px] right-0 w-[237px] h-[228px] rounded-tl-[20px] rounded-bl-[20px] bg-[rgba(0,255,224,0.3)] flex items-center justify-center cursor-pointer">
    Personalized
    </div>
    <img class="w-[639px] h-[388px]" src="/page-6-shoe.png" alt="Main Content Image"/>
  </div>
</div>
